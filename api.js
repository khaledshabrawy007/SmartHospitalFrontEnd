...
const AdmissionsAPI = {
    ...
    getByWard: (wardId)           => apiFetch(`/api/admissions/ward/${wardId}`),
    ...
    saveTreatmentResult: (patientId, dto) => apiFetch(`/api/admissions/patient/${patientId}/treatment-result`, { method: 'POST', body: JSON.stringify(dto) })
};
